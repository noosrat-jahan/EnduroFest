          ...
          >
            <div className="bg-white shadow-lg rounded-lg h-full overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-green-800 font-semibold">
                  Registration: March 20 - April 30
                </p>
                <p className="text-gray-500 mt-3">
          ...
          >
            <div className="bg-white shadow-lg rounded-lg h-full overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-500 mt-3">
                  Celebrate diversity and unity with runners from across the
                  globe in Berlin.
                </p>
              </div>
            </div>
