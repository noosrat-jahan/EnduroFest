...
const MyApplicationRow = ({ myApplication, index }) => {
  ...
  const handleUpdateApplication = (e, id) => {
    ...
    axios
      .put(
        `${import.meta.env.VITE_API_URL}/all-applications/${id}`,
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`${import.meta.env.VITE_API_URL}/all-applications/${id}`)
          .then((res) => {
            console.log(res.data);
  ...
  return (
    <>
      <tr className="border-b border-opacity-20 dark:border-gray-300 dark:bg-gray-600 dark:text-gray-50">
        <td className="p-3">
          <p>{index + 1}</p>
        </td>
        <td className="p-3">
        ...
        <td className="p-3 text-center flex gap-3">
            ...
            <Dialog.Root>
              ...
              <Dialog.Portal>
                ...
                <Dialog.Content className="fixed left-1/2 top-1/2  w-[90vw] lg:max-w-[500px] h-4/5 -translate-x-1/2 -translate-y-1/2 rounded-md overflow-y-scroll bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none data-[state=open]:animate-contentShow">
                  ...
                  <form
                    onSubmit={(e) => {
                      handleUpdateApplication(e, myApplication?._id);
                    }}
                  ...
                  >
                    ...
                    <div className="form-control">
                      ...
                      <input
                        ...
                        className="input input-bordered"
                        required
                        defaultValue={myApplication?.first_name}
                      />
                    </div>
                    ...
                    <div className="form-control">
                      ...
                      <input
                        ...
                        className="input input-bordered"
                        required
                        defaultValue={myApplication?.last_name}
                      />
                    </div>
                    ...
                    <div className="form-control">
                      ...
                      <input
                        ...
                        className="input input-bordered"
                        required
                        defaultValue={myApplication?.contact_number}
                      />
                    </div>
                    ...
                    <div className="form-control">
                      ...
                      <input
                        ...
                        className="input input-bordered"
                        required
                        defaultValue={myApplication?.address}
                      />
                    </div>

                    {/* submit button  */}
                    <div className="form-control mt-6">
                      <button className="btn bg-cyan-600 text-lg font-semibold text-white">
                        Update
                      </button>
                    </div>
                  </form>
          ...
          <span className="px-3 py-1 font-semibold rounded-md text-red-600 dark:bg-violet-600 dark:text-gray-50">
            <button
              onClick={() => {
                handleDelete(myApplication._id);
              }}
            >
              <MdDelete />
            </button>
