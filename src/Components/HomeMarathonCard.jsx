            ...
            <div className='bg border border-gray-300 shadow-md'>
                <div className=' flex flex-col-reverse lg:flex-row gap-3 pb-4'>
                    <div className='p-3  space-y-3'>
                        ...
                        <p className='flex items-center gap-2 pb-20 font-semibold text-red-800 '><LuCalendarDays /> Registration Ends: {format(marathon.regEndDate, 'MMMM do, yyyy')}</p>
                                    ...
                                    {({ remainingTime }) => {
                                        ...
                                        return (
                                            <div className="text-center pb-20 ">
                                                <h1 className='text-green-900 font-bold text-xl '>Event Starts In</h1>
                                                <div className="grid grid-cols-4 gap-16  items-center">
                                                    ...
                                                    <div className="flex flex-col items-center">
                                                        <span className="text-2xl font-bold text-pink-600">{minutes}</span>
                                                        <span className="text-sm text-black">Minutes</span>
                                                    </div>
                                                    <div className="flex flex-col items-center">
                                                        <span className="text-3xl font-bold text-black">{seconds}</span>
                        ...
                        <div className='z-30'>
                        <Link to={`/all-marathons/${marathon._id}`} className='bg-yellow-300  font-bold font-roboto uppercase px-5 w-2/3 py-2 flex items-center gap-1 rounded-sm cursor-pointer'>See Details <GoArrowRight /></Link>
                        </div>
                    </div>
