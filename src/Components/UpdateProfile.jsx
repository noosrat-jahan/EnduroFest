...
const UpdateProfile = () => {
    ...
    return (
        <div>
            <div className="card bg-base-100 mx-auto p-10 my-10 w-full max-w-md shrink-0 shadow-xl">
                <form onSubmit={handleUpdateProfile} className="card-body p-0 space-y-3">
                    <h1 className='text-2xl text-center font-bold text-purple-900'>Update Profile Information</h1>
