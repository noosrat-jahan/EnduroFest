...
//   if (!mounted) return null;
  ...
  return (
    <div className="navbar sticky top-0  shadow z-10 bg-base-100 dark:bg-black  bg-gradient-to-r from-pink-50 to-purple-100  px-4 py-3 mx-auto">
          ...
          >
            ...
            {user && (
              <NavLink
                ...
                className="bg-[#3E5879] text-white  rounded-md lg:px-3 px-2 py-2 lg:text-xl text-xs font-bold"
              >
                Dashboard
              </NavLink>
            )}
      ...
      <div className="navbar-center lg:pr-6 lg:flex  gap-2">
        <ul className="menu hidden lg:flex menu-horizontal px-1 space-x-4">
          ...
          {user && (
            <NavLink
              to="/dashboard/my-marathon-list"
              className="bg-[#36388b] text-white  rounded-md lg:px-3 px-2 py-2 lg:text-xl text-xs font-bold"
            >
              Dashboard
            </NavLink>
          )}
        ...
        {user ? (
          <div className="flex gap-5 items-center">
            ...
            <div className="dropdown w-16 h-16 block dropdown-hover">
              ...
              <ul
                tabIndex={0}
                className="dropdown-content menu bg-base-100 rounded-box z-10 w-48 space-y-3 p-2 shadow right-0"
              >
                <li>
                ...
                <li>
                  <Link
                    to="/update-profile"
                    className="bg-[#4fb5e1] lg:px-4 px-3 py-2 rounded-md text-white text-xs lg:text-lg font-bold"
                  >
                    Update Profile
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    className="bg-[#696be3] lg:px-4 px-3 py-2 rounded-md text-white text-xs lg:text-lg font-bold"
                  >
                    Log Out
                  </Link>
                </li>
          ...
          <div className="flex gap-3">
            ...
            <Link
              to="/register"
              className="bg-pink-500 lg:px-4 px-2 py-2 rounded-md text-white font-bold text-xs lg:text-lg"
            >
              Register
            </Link>
          </div>
